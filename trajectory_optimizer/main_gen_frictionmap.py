...
path2reftrack_file = os.path.join(path2module, 'traj_optimizer_inputs', 'tracks', track_name + '.csv')
path2tpamap_file = os.path.join(path2module, 'traj_optimizer_inputs', 'frictionmaps', filename_tpamap)
path2tpadata_file = os.path.join(path2module, 'traj_optimizer_inputs', 'frictionmaps', filename_tpadata)
