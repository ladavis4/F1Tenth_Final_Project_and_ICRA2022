...
from find_centerline_team4 import find_and_save_centerline
...
find_and_save_centerline(map_name)
...
file_paths["traj_race_export"] = os.path.join(os.path.join(os.getcwd(), os.pardir), "racelines", map_name + "_points.csv")
